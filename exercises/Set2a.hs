...
safeIndex xs i = if isValidIndex i xs then Just (xs !! i) else Nothing
    where isValidIndex i xs = i < length xs && i >= 0

-- Note: Find out how to make this nicer, this is ugly.
